            ...
            if (ImGui::TreeNode("Usage Scenarios"))
            {
                ...
                if (ImGui::TreeNode("5. Claiming CTRL+A shortcut globally"))
                {
                    ...
                    if (enable_ctrl_a_robbery)
                        ImGui::SetShortcutRouting(ImGuiMod_Ctrl | ImGuiKey_A, ImGuiInputFlags_RouteGlobalHighest, 0);
                ...
                if (ImGui::TreeNode("7. Claiming ESC away from an InputText()"))
                {
                    ...
                    if (ImGui::IsItemActive())
                    {
                        ...
                        if (ImGui::Shortcut(ImGuiKey_Escape, ImGuiInputFlags_RouteGlobalHighest, robber_id))
                        {
                            strcpy(buf, "Esc!");
                            ImGui::ClearActiveID();
                        }
                ...
                if (ImGui::TreeNode("9. Claiming Tab, CTRL+Tab"))
                {
                    ...
                    case 4:
                        ...
                        ImGui::SetShortcutRouting(ImGuiMod_Ctrl | ImGuiKey_Tab, ImGuiInputFlags_RouteFocused, ImGuiKeyOwner_NoOwner);
                        ImGui::SetShortcutRouting(ImGuiMod_Ctrl | ImGuiMod_Shift | ImGuiKey_Tab, ImGuiInputFlags_RouteFocused, ImGuiKeyOwner_NoOwner);
                        break;
                    case 5:
                    ...
                    case 6:
                    {
                        ...
                        if (ImGui::Shortcut(ImGuiMod_Ctrl | ImGuiKey_Tab, ImGuiInputFlags_RouteGlobalHighest, id))
                            counter++; // You could perform some other action here.
                        if (ImGui::Shortcut(ImGuiMod_Ctrl | ImGuiMod_Shift | ImGuiKey_Tab, ImGuiInputFlags_RouteGlobalHighest, id))
                            counter--;
                        break;
                    }
                    case 7:
